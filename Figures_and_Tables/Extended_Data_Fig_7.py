...
Set shuffle_idx = '01' to reproduce Extended Data Figure 7 present in the paper
"""
shuffle_idx = '01'
...
plt.savefig(f'Ext_Data_Fig_7_{model_taken_out}.png', dpi=300, bbox_inches='tight')
