...
axs[0].set_title('DNNs ensemble', loc='center', size=size_title_axes, pad=17, **font)
axs[0].coastlines()
...
cs2=axs[1].contourf(lons_cyclic,lats,simulation_warming_cyclic_data,levels=levels,
                        transform = ccrs.PlateCarree(),
                        cmap=colormap,vmin=-30, vmax=30)
axs[1].set_title('CMIP6 ensemble', loc='center', size=size_title_axes, pad=17, **font)
axs[1].coastlines()
...
axs[2].set_title('Bias (DNNs - CMIP6)', loc='center', size=size_title_axes, pad=17, **font)
axs[2].coastlines()
...
plt.text(x=0.12, y=0.91, s='a', fontweight='bold',
         fontsize=size_suptitlefig, ha="center", transform=fig.transFigure, **font)
plt.text(x=0.385, y=0.91, s='b', fontweight='bold',
         fontsize=size_suptitlefig, ha="center", transform=fig.transFigure, **font)
plt.text(x=0.65, y=0.91, s='c', fontweight='bold',
         fontsize=size_suptitlefig, ha="center", transform=fig.transFigure, **font)

plt.savefig(f'Fig_4.png', bbox_inches = 'tight', dpi=300)
plt.close()